...
var P12 = [
	0.6931471824645996, // 0x1.62e430p-1f
	0.24022650718688965 // 0x1.ebfbe0p-3f
];
var P34 = [
	0.055505409836769104, // 0x1.c6b348p-5f
	0.009618354961276054  // 0x1.3b2c9cp-7f
];
...
function main() {
	...
	fpath = resolve( __dirname, '..', 'lib', 'polyval_p34.js' );
	str = header + compile( P34 );
	writeFileSync( fpath, str, opts );
	...
	copts.name = 'polyval_p34';
	str = compileC( P34, copts );
	file = insert( file, copts.name, str );
